...
<html lang="en">
  ...
  <body>
    <div style="position:relative">
      <img src="{{asset('img/top_right.jpg')}}" alt="" style="max-width: 200px;  position:absolute; top:-50px; right:-50px" />
    </div>

    <table style=" width: 100%;font-family: sans-serif; font-size: 14px; position:relative; z-index:1">
      <tbody>
        <tr>
          <td style="text-align: center; padding: 40px 0 10px; position:relative">
            <img src="{{asset('img/newlogo.jpg')}}" alt="" style="max-width: 200px; "/>
          </td>
        </tr>
        <tr>
          <td style="text-align: center">
            <h2 style="font-weight: bold; margin: 40px 0 0; font-size: 22px; font-family: sans-serif;">ADDITIONAL WARRANTY CARD</h2>
            <!-- <h4 style="font-weight: 400; margin: 10px 0 0; font-size: 20px;">4 Years From Date of Purchase</h4> -->
            <img src="{{asset('img/badge.png')}}" style="position: absolute;right: 0px;top:-20px;width: 180px;" alt="">
          </td>
        </tr>
        <tr>
            <td style="padding: 50px 0 0">
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="font-size: 14px; margin: 0 auto; width: 100%; background-color: rgb(0 0 0 / 3%); border:1px solid #ffffff"">
                    <tr>
                        <td style="padding: 13px 20px ; font-weight: bold; border:1px solid #ffffff">Name  </td>
                        <td style="padding: 13px 20px ; border:1px solid #ffffff"><span style="font-weight:normal">{{$collection['name']}}</span></td>
                    </tr>                   
                    <tr>
                        <td style="padding: 13px 20px ; font-weight: bold; border:1px solid #ffffff">Order ID  </td>
                        <td style="padding: 13px 20px ; border:1px solid #ffffff"><span style="font-weight:normal">{{$collection['order_id']}}</span></td>
                    </tr>                   
                    <tr>
                        <td style="padding: 13px 20px ; font-weight: bold; border:1px solid #ffffff">Product  </td>
                        <td style="padding: 13px 20px ; border:1px solid #ffffff"><span style="font-weight:normal">{{$collection['category']}}</span></td>
                    </tr>                   
                    <tr>
                        <td style="padding: 13px 20px ; font-weight: bold; border:1px solid #ffffff">Model  </td>
                        <td style="padding: 13px 20px ; border:1px solid #ffffff"><span style="font-weight:normal">{{$collection['model_no']}}</span></td>
                    </tr>
                    <tr>
                        <td style="padding: 13px 20px ; font-weight: bold; border:1px solid #ffffff">Date of Purchase  </td>
                        <td style="padding: 13px 20px ; border:1px solid #ffffff"><span style="font-weight:normal">{{$collection['date_of_purchase']}}</span></td>
                    </tr>                   
                    <tr>
                        <td style="padding: 13px 20px ; font-weight: bold; border:1px solid #ffffff">Additional Warranty Period  </td>
                        <td style="padding: 13px 20px ; border:1px solid #ffffff"><span style="font-weight:normal">{{$collection['warranty_period_from']}} - {{$collection['warranty_period_to']}}</span></td>
                    </tr>
                </table>
            </td>
