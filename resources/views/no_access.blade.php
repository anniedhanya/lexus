<html>
<body>
  <div id="spam" class="mt-100">
    <h1><spam>X</spam> Access Denied</h1>
    <p>You dont have permission to access this. <br><br><br> 
   
                                        <a href="{{url('/admin/extended_warranty')}}"  class="btn btn-default btn-flat" >
                                            Dashboard
                                        </a>
                                      

              <!--  <form id="logout-form" action="{{url('/admin/dashboard')}}" method="POST" style="display: none;">
                                            {{ csrf_field() }}
               </form> -->
...
<svg xmlns="http://www.w3.org/2000/svg" width="120px" height="120px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" class="uil-gears">
  <rect x="0" y="0" width="100" height="100" fill="none" class="bk"/><g transform="translate(-20,-20)">
...
.mt-100
{margin-top:200px!important; padding:50px 10px;}
#spam {
...
.btn
{background: #f57900 !important; border-color: #f57900 !important; padding:10px; color:#fff; border-radius:7px; text-decoration: none;}
</style>
</html>