                                ...
                                <div class="row">                              
                                  ...
                                  <!-- <div class="col-sm-6 d-flex align-items-center"> 
                                    <ul class="nav navbar-right panel_toolbox table-menu-sec">
                                      ...
                                      <!-- <li>
                                        <a href="#" class="btn btn-primary border-0 new-page-btn"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp; New</a>
                                      </li> -->
                                      <!-- <li>
                  ...
                  if(data.total_count > 0)
                  {
                      ...
                      for(var i=0;i<data.count;i++)
                      {
                        ...
                        var str = '<tr>';
                             ...
                             str += '<td>'+slno+'</td><td>'+data.result[i].title+'</td><td>'+data.result[i].phone_number+'</td><td>'+data.result[i].email+'</td><td><a href="' +url_+'/admin/settings/'+data.result[i].id + '/edit'+'" class="" title="Edit"><img src="{{asset('img/edit.svg')}}" alt="Edit Icon" height="25"></a></td>';
                        str +='</tr>';
                ...
                { $('#datatable_ tbody').html('');
                  if(data.total_count > 0)
                  {
                      ...
                      for(var i=0;i<data.count;i++)
                      {
                        ...
                        var slno = j+data.offset;
                        var str = '<tr>';
                        str += '<td>'+slno+'</td><td>'+data.result[i].title+'</td><td>'+data.result[i].phone_number+'</td><td>'+data.result[i].email+'</td><td><a href="' +url_+'/admin/settings/'+data.result[i].id + '/edit'+'" class="" title="Edit"><img src="{{asset('img/edit.svg')}}" alt="Edit Icon" height="25"></a>';
                        str +='</td></tr>';
